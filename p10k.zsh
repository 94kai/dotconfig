# Generated by Powerlevel10k configuration wizard on 2025-08-25 at 20:20 CST.
...
# 2 lines, solid, no frame, lightest-ornaments, compact, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='未跟踪'
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${clean}储藏${VCS_STATUS_STASHES}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}冲突${VCS_STATUS_NUM_CONFLICTED}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}暂存${VCS_STATUS_NUM_STAGED}"
    # (( VCS_STATUS_NUM_STAGED     )) && res+=" ${modified}+${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}未暂存${VCS_STATUS_NUM_UNSTAGED}"
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_SWAP_VISUAL_IDENTIFIER_EXPANSION='SWAP'
